...
const copy = {
  en: {
    ...
    select: "Select", from: "From", back: "Back", addToCart: "Add to cart", viewCart: "View cart",
  ...
  fr: {
    ...
    select: "Sélectionner", from: "À partir de", back: "Retour", addToCart: "Ajouter au panier", viewCart: "Voir le panier",
