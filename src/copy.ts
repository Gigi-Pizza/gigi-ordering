...
const copy = {
  en: {
    ...
    empty: "Your cart is empty.", placeOrder: "Place order (pickup)", confirmed: "Order ready to send", size: "Size", each: "each", quantity: "Quantity",
  },
  fr: {
    ...
    empty: "Votre panier est vide.", placeOrder: "Commander (pour emporter)", confirmed: "Commande prête à envoyer", size: "Format", each: "ch.", quantity: "Quantité",
  },
};
